		...
		basics: {
			...
			features: {
				...
				t1: "Features like responsive nested grids with vertical alignment, like themes, like usefull mixins" +
					"and functions, like simple sprites and gradients (in original Compass it is so complicated) and" +
			...
			requirements: {
				_: "Requirements",
				t1: "Just",
				t2: "both in the PATH variable"
			},
			createproject: {
				_: "Creating a project",
				t1: "Project is already created. Launch watcher <code>executable/compass_watch.bat</code> or <code>executable/compass_watch.sh</code> and dive into development."
			},
			styleguides: {
				_: "Styleguides",
				html: {
					classes: "<b>Classes</b> are named in <code>UpperCamelCase</code> (which is good if you use a different style);",
			...
			structure: {
				...
				initialization: {
					...
					helpers: "Including classes for grids, text, etc",
					icons: "Including classes for Entypo icons",
					buttons: "Including standard classes of buttons, which\n   is required by theme",
					theme: "Initializing of STRAPDocs theme"
				},
				advices: {
		...
		layout: {
			...
			grid: {
				...
				howtouse: {
					...
					t4: "3. And finally, add the <code class='language-css'>.Content</code> block inside of each column.",
					e1: "8 columns",
					e2: "4 columns"
				},
				nested: {
